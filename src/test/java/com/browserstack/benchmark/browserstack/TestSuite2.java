...
@Ignore
public class TestSuite2 extends BrowserstackParallelTestBase {
  
  private static final Logger LOGGER = Logger.getLogger(TestSuite2.class.getName());

  public TestSuite2(String os, String osVersion, String browser,
      String browserVersion, String realMobile, String device) {
    super(os, osVersion, browser, browserVersion, realMobile, device);
  }
...
//    assertTrue(testTime > (3 * 1000) && testTime < (4 * 1000));
  ...
  public void verifyCloseCurrentWindowTest() {
    ...
    LOGGER.info(message);
    assertTrue(message.contains("no such"));
  }
